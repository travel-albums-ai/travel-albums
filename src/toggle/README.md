# Toggle components guide

This folder contains small, composable UI controls that are built around a shared button abstraction. The goal is to keep each toggle thin, readable, and consistent with the rest of the app.
...
When creating a new toggle, follow this checklist:
