...
import SettingTrileanRow from '@/windows/settings/components/SettingTrileanRow';
import CountriesFilter from '@/windows/settings/filters/CountriesFilter';
import DatesFilter from '@/windows/settings/filters/DatesFilter';
